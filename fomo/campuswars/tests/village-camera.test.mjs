...
test('paused activity keeps loading a selected distant house until its scene is ready',()=>{
  const h=cameraHarness();h.show(true);h.step(20);h.fire('document:party:pause',{detail:{paused:true}});h.step(1);
