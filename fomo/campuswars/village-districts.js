...
import {createCampusKit} from './village-campus-kit.js?v=98';
import {buildSkylineBuilding} from './village-skyline.js?v=98';
...
import {createStadium,STADIUM_SITE} from './village-stadium.js?v=90';
